...
Simple web scraper for extracting exhibitor data from trade show exhibitor lists provided by **A2Z Events**. Easily scrape company profiles including **company details, websites, social media links, product categories, and more**. 

Ideal for **B2B lead generation, market research, event networking, and competitive analysis**. Supports multiple **A2Z Events** exhibition websites with a consistent HTML structure.
...
- [Supported A2Z Events Exhibitions (Exhibitor Lists)](#supported-a2z-events-exhibitions-exhibitor-lists)
...
- Scrape all exhibitor profiles from supported A2Z Events event websites
...
- This scraper is designed to extract data from exhibitor directories with the same HTML structure as the supported A2Z Events exhibitor lists below.
...
```json
{
  "___exhibitor_profile_url": "https://cedia2026.smallworldlabs.com/co/blackwire-designs",
  "__company_name": "Blackwire Designs",
  "_company_address": "Phoenix, AZ, United States",
  "_company_country": "United States",
  "_company_website": "https://www.blackwiredesigns.com",
  "_hall_stands": "4311",
  "_social_url_linkedin": "https://www.linkedin.com/company/blackwiredesigns/",
  "_social_url_facebook": "https://www.facebook.com/blackwiredesigns",
  "_social_url_instagram": "https://www.instagram.com/blackwiredesigns/",
  "keywords": "AvPro, Audiocontrol, Acurus, Bose Professional, Cleerline, Dylan Innovations...",
  "product_categories": [
    "Remote Control Systems Accessories",
    "Control Panels & Interfaces",
    "Multi-Room Control Systems",
