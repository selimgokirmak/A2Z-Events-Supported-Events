...
Simple web scraper for extracting exhibitor data from trade show exhibitor lists provided by **A2Z Events**. 
...
Supports multiple **A2Z Events** exhibition websites with a consistent HTML structure.
